...
for I = 1:NbDiodes
    ...
    if (DIODE_LIST(I).node1 ~= 0) && (DIODE_LIST(I).node2 ~= 0) 
        ...
        f_d(DIODE_LIST(I).node1, DIODE_LIST(I).node2) = f_d(DIODE_LIST(I).node1, DIODE_LIST(I).node2) - (Is/Vt)*exp((v1-v2)/Vt);
        f_d(DIODE_LIST(I).node2, DIODE_LIST(I).node1) = f_d(DIODE_LIST(I).node2, DIODE_LIST(I).node1) - (Is/Vt)*exp((v1-v2)/Vt);
